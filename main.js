...
function decfmt() {
  if (DecSep == ",") {
    ...
    for (let i = 0; i < imgs.length; i++) {
      if (
        imgs[i].getAttribute("hasdec") != null &&
...
function citation() {
  ...
  let mDate =
    md.getDate() + " " + months[md.getMonth()] + " " + md.getFullYear();
...
function doQ(id, qs) {
  ...
  let url =
    "http://www.mathopolis.com/questions/q.html?id=" + parseInt(id) + "&t=mif";
...
function menuHTML(typ) {
  ...
  if (typ == 1) {
    s +=
      '<ul role="list" class="bga1" style="display:inline-block; padding:6px; border-radius:10px; ">';
    let ht = 36;
    s += '<li style=" padding:0px 7px;">';
    s +=
      '<a href="' +
      urlStt +
      'index.htm" style="text-decoration: none;  padding:0px;" aria-label="Home">';
    s +=
      '<img src="' +
      urlStt +
      'images/style/home.svg" style="height:' +
      ht +
      'px; vertical-align:middle;" alt="Home" />';
    s += "</a>";
    s += "</li>";
    ...
    s +=
      '<a href="' +
      urlStt +
      'numbers/calculator.html" style="text-decoration: none;  padding:0px;" aria-label="Show Calculator">';
    s +=
      '<img src="' +
      urlStt +
      'images/style/calculator.svg" style="height:' +
      ht +
      'px; vertical-align:middle;" alt="Calculator" />';
    s += "</a>";
    s += "</li>";
    s += '<li style=" padding:0px 7px;">';
    s +=
      '<a href="' +
      urlStt +
      'search/search.html" style="text-decoration: none; padding:0px;" aria-label="Show Search">';
    s +=
      '<img src="' +
      urlStt +
      'images/style/search.svg" style="height:' +
      ht +
      'px; vertical-align:middle;" alt="Search" />';
    s += "</a>";
    s += "</li>";
    s += "</ul>";
  }
...
function relatedLinks() {
  ...
  if (left != null) {
    s +=
      ...
      top +
      'px; left: 0px; text-align: left; z-index:2;">';
  ...
  if (right != null) {
    s +=
      '<div style="position: absolute; top: ' +
      top +
      'px; right: 0px; text-align: right; z-index:2;">';
...
function fmtMenuBox(url, txt, dirn) {
  ...
  s +=
    '<a href="' +
    url +
    '"  style="text-decoration: none; color: #8ac; line-height:1.3rem; ">';
  s += '<div id="' + boxID + '">';
  s += txt;
  s += "</div>";
  s += "</a>";
...
function searchKey(ev) {
  ...
  if (main.searchScript == "no") {
    ...
    let imgHome =
      (document.domain == "localhost" ? "/mathsisfun" : "") + "/search/images/";
  ...
  iframe.addEventListener("load", function () {
    ...
    setInterval(function () {
      ...
      if (!btnQ) {
        ...
        if (div != null) {
          let btnStr =
            '<button type="button" class="btn" style="z-index:2; position:absolute; right:0; bottom:0;" onclick="iframeMax(\'' +
            filename +
            "'," +
            wd +
            "," +
